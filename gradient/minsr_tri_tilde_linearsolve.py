...
import numpy as np
import scipy
def get_gradient_minsr_tri_tilde_linearsolve(derlogs, sample_size, eloc, num_param_amp):
    """
    ...
    intermediate = scipy.linalg.cho_solve((cholesky, True),R_vec_stack)
    final_grads = tf.cast(O_mat_weighted_stack.T @ intermediate, tf.float32)
