...
import numpy as np
def get_gradient_minsr_tri_tilde(derlogs, sample_size, eloc, num_param_amp):
    """
    ...
    final_grads = tf.convert_to_tensor(O_mat_weighted_stack.T @ T_reg_inv @ R_vec_stack, tf.complex64)
