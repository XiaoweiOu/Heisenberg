...
load_model_path = 'result/AmpCNNPhiMultiLinearTest_SUN6_mass4_symmetrized_adaptivestep' #'result/AmpCNNPhiMultiLinearTest_SUN6_minsr_recover'
initial_sample_path = 'result/AmpCNNPhiMultiLinearTest_SUN6_mass4_symmetrized_adaptivestep_samples.npy' #'result/AmpCNNPhiMultiLinearTest_SUN6_minsr_recover_samples.npy'
if load_model_path is not None:
    learning_rate = 0.08753318 #last step size
...
run_name = mlp.__class__.__name__+'_SUN'+str(square2d.length)+'_mass4_symmetrized_adaptivestep'
is_save = True
