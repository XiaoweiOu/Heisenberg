...
learning_rate = 0.006 # default = 0.04
load_model_path = 'result/AmpCNNPhiMultiLinearTest_SUN6_minsrmass4_symmetrized_adaptivestep_beta0.09_j205' #'result/AmpCNNPhiLinearLarger_SUN6_minsr_mass2_j205'
initial_sample_path = 'result/AmpCNNPhiMultiLinearTest_SUN6_minsrmass4_symmetrized_adaptivestep_beta0.09_j205_samples.npy' #'result/AmpCNNPhiLinearLarger_SUN6_minsr_mass2_j205_samples.npy'
if load_model_path is not None:
    learning_rate = 0.17078829
...
run_name = mlp.__class__.__name__+'_SUN'+str(square2d.length)+'_minsrmass4_symmetrized_adaptivestep_beta0.09_j205'
is_save = True
