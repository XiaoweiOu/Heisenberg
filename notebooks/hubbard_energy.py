...
from learner import Learner,KerasLearner,TestKerasLearner
...
## Define the sampler
sampler = MetropolisHubbard(num_samples=36, num_sites=square2d.num_points)

## If load trained network and initial samples
load_model_path = 'result/AmpCNNPhiPhasorHubbard_hubbard2'
initial_sample_path = 'result/AmpCNNPhiPhasorHubbard_hubbard2_samples.npy'
