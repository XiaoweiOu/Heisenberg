...
from model import AmpCNNPhiMSR,AmpCNNPhiPhasor,AmpCNNPhiLinear,AmpCNNPhiMultiLinear,AmpCNNPhiMultiLinearTest,AmpCNNComplexPhiMultiLinear
...
run_name = mlp.__class__.__name__+'_SUN'+str(square2d.length)+'_pureSR_new_symmetrized_j205'
is_save = True
...
learner = KerasLearner(hamiltonian = hamil, model = mlp, sampler = sampler, optimizer = optimizer,
                  ...
                  reference_energy = reference_energy[str(square2d.length)], use_gradient = 'sr_new',
