...
from model import AmpCNNPhiMSR,AmpCNNPhiPhasor,AmpCNNPhiLinear,AmpCNNPhiLinearLarger,AmpCNNPhiMultiLinear,AmpCNNPhiMultiLinearTest,AmpUnitPhiMultiLinearTest,AmpCNNComplexPhiMultiLinear
...
learning_rate = 0.04
load_model_path = None #'result/AmpCNNPhiLinearLarger_SUN6_minsr_mass2_j205'
initial_sample_path = None #'result/AmpCNNPhiLinearLarger_SUN6_minsr_mass2_j205_samples.npy'
...
run_name = mlp.__class__.__name__+'_SUN'+str(square2d.length)+'_minsrmass4_symmetrized_fixedstep_j205'
is_save = True
